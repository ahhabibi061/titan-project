          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 py-8 pb-36">
            <header className="flex items-end justify-between gap-6 mb-8 pb-6 border-b border-stone-800/60">
              <div className="flex items-baseline gap-2">
                <span className="font-anton text-5xl uppercase tracking-tight text-stone-100">FORGE</span>
                <span className="forge-page-title font-anton text-5xl uppercase tracking-tight bg-gradient-to-br from-orange-300 to-orange-600 bg-clip-text text-transparent">LOGGER</span>
              </div>
