        ...
        <div className="min-h-screen w-full bg-[#0a0908] text-stone-100 font-sans antialiased">
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 py-8 pb-36">
            <header className="flex items-end justify-between gap-6 mb-8 pb-6 border-b border-stone-800/60">
              <span className="font-anton text-5xl uppercase tracking-tight forge-page-title bg-gradient-to-br from-orange-300 to-orange-600 bg-clip-text text-transparent">FORGE LOGGER</span>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 py-8">
        ...
        <header className="grid grid-cols-3 items-center gap-4 mb-8 pb-6 border-b border-stone-800/60">
          ...
          <div className="flex items-baseline gap-3 flex-wrap min-w-0">
            <span className="font-anton text-4xl uppercase tracking-tight forge-page-title bg-gradient-to-br from-orange-300 to-orange-600 bg-clip-text text-transparent">FORGE LOGGER</span>
          ...
          {!workoutId && (
            <div className="flex flex-col items-center">
              ...
              <div className="forge-session-timer font-anton text-4xl tabular-nums text-orange-400 leading-tight">{mins}:{secs}</div>
            </div>
          )}
          {workoutId && <div />}
          ...
          <div className="flex items-center gap-2 justify-end flex-wrap">
            ...
            {workoutId ? (
              ...
              <button
                ...
                className="forge-finish-btn px-4 py-2 bg-orange-500 text-stone-950 font-anton text-base uppercase tracking-wider hover:bg-orange-400 transition-colors"
              >
                ✓ Finish
              </button>
            )}
